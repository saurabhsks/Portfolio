...
#stars {
  ...
  .s-intro-background {
    overflow: hidden;
    background: radial-gradient(ellipse at bottom, ${({ theme }) => theme.starsGrad1} 0%, ${({ theme }) => theme.starsGrad2} 100%);
    height: 100vh;
}
...
.work-box,
.card-blog {
    box-shadow: 0px 8px 18px 0px ${({ theme }) => theme.shadowColor};
}
...
a.timeline-link-icon{
  color: ${({ theme }) => theme.textDark};
}
a.timeline-link-icon:hover{
  color: #0078ff;
}
...
.navbar-b.navbar-trans .nav-link.theme-toggler:before,
.navbar-b.navbar-reduce .nav-link.theme-toggler:before{
    height: 0px;
}

.navbar-b.navbar-trans .nav-link.theme-toggler,
.navbar-b.navbar-reduce .nav-link.theme-toggler{
    cursor: pointer;
}
...
.navbar-b.navbar-reduce .navbar-toggler span {
  background-color: ${({ theme }) => theme.navHamburgerColor};
}
...
span.s-projects-tech{
  background-color: #0078ff;
  opacity: ${({ theme }) => theme.projectTechOpacity};
...
.vertical-timeline.vertical-timeline--two-columns:before{
  box-shadow: 2.5px 0px 2px ${({ theme }) => theme.formTextBorder};
}

.vertical-timeline-element-content{
    background: ${({ theme }) => theme.container} !important;
}
