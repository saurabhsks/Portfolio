...
class About extends React.Component{
    constructor(){
        ...
        this.state = {
            skills:[
                {id:"Java_skill", content: "C++",percentage: "95%", value: "80", icon: <SiCplusplus /> },
                {id:"JavaScript_skill", content: "JavaScript",percentage: "85%", value: "80", icon: <SiJavascript /> },
                {id:"Python_skill", content: "Java",percentage: "60%", value: "60", icon: <FaJava /> },
                ...
                {id:"ReactJS_skill", content: "ReactJS",percentage: "90%", value: "75", icon: <FaReact /> },
                {id:"ReactNative_skill", content: "Spring Framework",percentage: "80%", value: "70", icon: <SiSpring />},
                {id:"Flutter_skill", content: "PHP",percentage: "80%", value: "80", icon: <SiPhp />                },
