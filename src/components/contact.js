                        ...
                        <div className="row">
                            ...
                            <div className="more-info">
                                ...
                                <ul className="list-ico">
                                    <li><span className="ion-ios-location"></span> Ranchi, IN </li>
                                    {/* <a href="tel:+91-7021624827" ><li><span className="ion-ios-telephone"></span> +91-7021624827</li></a> */}
                                    <li><a href="mailto:saurabhsingh@gmail.com"><span className="ion-email"></span> </a> saurabhsingh982001@gmail.com</li>
                                    {/* <li><span class="ion-email"></span> shubh.as@somaiya.edu</li> */}
                                </ul>
                            </div>
                            <div className="socials">
                                <ul>
                                <li><a href="https://github.com/saurabhsks" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-github"></i></span></a></li>
                                <li><a href="https://www.linkedin.com/in/saurabh-kumar-singh-4a5a50192/" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-linkedin"></i></span></a></li>
                                <li><a href="https://www.instagram.com/saurabh_.kumar_.singh/" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-instagram"></i></span></a></li>
                                <li><a href="mailto:saurabhsingh982001@gmail.com" target="_blank" rel="noopener noreferrer"><span className="ico-circle"><i className="ion-social-google"></i></span></a></li>
                                </ul>
                            </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    ...
                    <div className="col-sm-12">
                        <div className="copyright-box">
                            <p className="copyright">Copyright &copy; {new Date().getFullYear()} <strong>Saurabh Kumar Singh</strong></p>
                        </div>
                    </div>
                    </div>
                </div>
