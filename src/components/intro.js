              ...
              <div className="table-cell">
                <div className="container">
                  ...
                  <p className="intro-subtitle">
                    ...
                    <strong className="text-slider"><Typed strings={['Front End Developer', 'Back End Developer', 'Freelancer','Subject Matter Expert']} typeSpeed = {80} backDelay = {1100} backSpeed = {30} loop/></strong>
                  </p>
                  <p className="pt-3">
                    <a 
                      className="btn btn-primary btn js-scroll px-4" 
                      style={{ cursor: "pointer" }}
                      href= {`/files/Saurabh_Resume.pdf?${new Date().getTime()}`}
                      target="_blank"
